...
import { BarChart3, Compass, LogIn, Megaphone } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 flex flex-col border-b border-slate-200 bg-white/85 backdrop-blur-md">
      <div className="flex items-center justify-between gap-4 px-4 sm:px-8 py-3 sm:py-4">
        <div className="flex items-center gap-4 lg:gap-8 min-w-0">
          ...
          >
            <div className="flex h-9 w-9 sm:h-11 sm:w-11 items-center justify-center rounded-xl bg-teal-50 text-teal-700 border border-teal-100 shadow-sm">
